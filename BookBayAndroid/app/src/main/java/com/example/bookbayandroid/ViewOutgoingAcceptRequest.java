...
public class ViewOutgoingAcceptRequest extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_viewoutgoingacceptrequest);
        setTitle("Request");

        SharedPreferences sp1=this.getSharedPreferences("userdetails", MODE_PRIVATE);
        String requestid=sp1.getString("outgoingacceptrequestid", null);
