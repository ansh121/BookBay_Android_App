...
public class CustomAdapterSearchBook implements ListAdapter {
    ArrayList<MyBooksData> arrayList;
    Context context;
    public CustomAdapterSearchBook(Context context, ArrayList<MyBooksData> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null) {
            ...
            convertView=layoutInflater.inflate(R.layout.searchresultelement, null);
