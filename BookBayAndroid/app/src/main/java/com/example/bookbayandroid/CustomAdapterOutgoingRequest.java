...
public class CustomAdapterOutgoingRequest implements ListAdapter {
    ArrayList<IncomingRequestData> arrayList;
    Context context;
    public CustomAdapterOutgoingRequest(Context context, ArrayList<IncomingRequestData> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null) {
            ...
            convertView=layoutInflater.inflate(R.layout.outgoing_request_element, null);
